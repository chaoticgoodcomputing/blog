...
2. However — since restarting writing during the Season of Systems, I've decided to take certain portions of this site private. The two primary private collections are periodic notes, as well as initial drafts of notes. The metadata for these notes (titles, tags, forward- and backlinks) are preserved, but the actual contents of the notes are contained in a separate repository. These notes will all be labelled with the [[tags/private/index|private]] tag. I don't necessarily want them *publicly* available, but if one does seem interesting to you, please [[public/contact|contact me]] and — more likely than not — I'd be happy to chat about the original contents.
