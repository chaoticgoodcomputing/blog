...
- Subtags are dedicated to notes about individual patterns (effectively chapters of the text). These are broken into two categories:
  - `#super`: If we think of an individual building as a structure, these are rules regarding **super**structures — communities, neighborhoods, road systems, etc.
  - `#sub`: Under the same thinking, these are rules for anything related to **sub**structures — walls, windows, doors, etc.

Annotations for individual rules will likely remain private, unless I feel they're particularly good insights or relate directly back to any of the general insights notes.
