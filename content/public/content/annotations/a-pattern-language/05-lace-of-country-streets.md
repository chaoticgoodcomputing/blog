...
tags:
  ...
  - economics/policy
description: How dense is too dense? How sparse is too sparse? Annotations for A Pattern Language's proposals for the density of metro-adjacent country streets for agriculture, recreation, and preservation.
---
← [[04-agricultural-valleys|Agricultural Valleys]] | [[06-country-towns|Country Towns]] →
...
![[assets/Pasted image 20260208153400.png]]
...
Performing the same analysis on the Elko-Spring Creek relationship — very much a Small Town-Rural relationship, based on the population counts from [[content/annotations/a-pattern-language/01-independent-regions|01-independent-regions]]:

![[assets/Pasted image 20260208154407.png]]

Even here, we see that a 1 square-mile setup is *wildly* sparse, with even modern rural areas not quite hitting that level of low-density. As a mild spoiler for [[content/annotations/a-pattern-language/06-country-towns|06-country-towns]], and borrowing from the policy argument made in [[content/annotations/a-pattern-language/02-the-distribution-of-towns|02-the-distribution-of-towns]] about city economies facilitating redistribution to fund necessary rural infrastructure that would be considered inefficient in a free market, this level of density, in this era, necessarily requires external policy support if it is to be preserved in scenarios where a nearby city's growth and development (can you see how I'm dancing around the word *sprawl?*) begins to encroach on yet-preserved surrounding areas.
...
![[assets/Pasted image 20260208155115.png]]