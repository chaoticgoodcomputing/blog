...
Patterns are such an important cornerstone of computing that it had never even crossed my mind that we *yoinked* it from somebody else.

## *A Pattern Language* — of another field

A few years ago, I stumbled on the 1977 urban planning and architecture reference manual *[A Pattern Language](https://arl.human.cornell.edu/linked%20docs/Alexander_A_Pattern_Language.pdf)* while researching more about design patterns for software. What I stumbled into, though, was a bit of hubris: software engineers didn't invent design patterns! We could hardly be credited for coming up with the *term*, never mind the *concept*. Other fields had been using design patterns decades before the phrase ever got close to computing.

> [!UPDATE]
> February 2nd, 2026 — while editing this note, I (re?)discovered that *A Pattern Language* isn't just *an earlier* use of the term "design patterns" — it's apparently the [original source](https://en.wikipedia.org/wiki/Design_pattern). I've had the book floating around my life for three years now, so I can't recall if going back to the root was the result of an intentional investigation, or just dumb luck.
> 
